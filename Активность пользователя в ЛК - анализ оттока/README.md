## Активность пользователя в ЛК - анализ оттока
...
Проверены гипотезы, даны инсайты об использовании платформы + запущены эксперименты по удержанию клиентов. Так же в рамках работы над задачей создана и описана методология определения оттока на платформе
